# DOX framework - HAREZM\brand\docs\strategy
...
- **[ekosistem strateji](file:///B:/DEV/HAREZM_EKOSISTEMI/HAREZM/brand/docs/strategy/ekosistem strateji/AGENTS.md)**: Subdirectory containing local files.
