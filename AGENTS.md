...
- **Role**: Main business site and ecosystem showcase.
- **Surface**: `https://harezm.com`
- **Type**: site
...
- **[assets](file:///B:/DEV/HAREZM_EKOSISTEMI/HAREZM/assets/AGENTS.md)**: Subdirectory containing local files.
- **[brand](file:///B:/DEV/HAREZM_EKOSISTEMI/HAREZM/brand/AGENTS.md)**: Shared brand strategy, design tokens, icons, and visual identity.
- **[public](file:///B:/DEV/HAREZM_EKOSISTEMI/HAREZM/public/AGENTS.md)**: Subdirectory containing local files.
- **[src](file:///B:/DEV/HAREZM_EKOSISTEMI/HAREZM/src/AGENTS.md)**: Subdirectory containing local files.
